    ...
    <div style="width: 100%; float: left">
        <fieldset class="fieldsetmain">
            ...
            <div id="divmain" runat="server">
                ...
                <asp:GridView ID="gvorder" runat="server" Width="850px" CaptionAlign="Top"
                    ...
                    <EmptyDataRowStyle BackColor="#eeeeee" BorderColor="Black"
                        BorderStyle="Solid" BorderWidth="1px" Font-Size="Large" ForeColor="black"
            ...
            <div style="width: 100%; margin-top: 10px" align="center">
                ...
                <div style="width: 850px; margin-top: 10px;">
                    <div style="width: 200px; float: right">
                        <span>TOTAL AMOUNT : $<asp:Label ID="lbltotPrice" runat="server" Text=""></asp:Label></span><br /><br /><br />


                       <asp:ImageButton id="imagebutton1" runat="server"
           AlternateText="ImageButton 1"
           ImageAlign="left"
           ImageUrl="~/Images/Bkash.png"
           OnClick="ImageButton_Click"/>
            ...
            <div style="width: 100%;" align="center" id="dvempty" runat="server" visible="false">
                <div>
                    <table cellspacing="2" cellpadding="3" rules="cols" style="background-color: White; border-color: #999999; border-width: 1px; border-style: None; height: 100px; width: 850px;">
