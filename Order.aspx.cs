...
public partial class Order : System.Web.UI.Page
{
    ...
    protected void ImageButton_Click(object sender, ImageClickEventArgs e)
    {
        ...
        // Construct the Bkash payment URL
        //string redirectUrl = "https://business.bkash.com/sign-in?merchantId="
                      //     + ConfigurationManager.AppSettings["BkashMerchantId"].ToString();
                           

        //First name I assign static based on login details assign this value
       // redirectUrl += "&first_name=VegEase Mart";
        //Product Name
       // redirectUrl += "&item_name=Grocery Items";
        //Product Amount
       // redirectUrl += "&amount=" + lbltotPrice.Text;
        //Business contact paypal EmailID
      //  redirectUrl += "&business=tfahim987@gmail.com";
