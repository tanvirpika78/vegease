<%@ Page Title="" Language="C#" MasterPageFile="~/Seller/GSSeller.master" AutoEventWireup="true" CodeFile="ViewOrders.aspx.cs" Inherits="OrderHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="float:left;width:100%" >
        <fieldset class="fieldsetmain">
            ...
            <div align="center">
                <asp:GridView ID="gvorderHistory" runat="server" Width="850px" CaptionAlign="Top"
