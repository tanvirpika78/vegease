        ...
        <fieldset class="fieldsetmain">
            ...
            <div id="dvMain" runat="server">
                <div style="width: 100%;" align="center">
                    ...
                    <asp:GridView ID="gvCart" runat="server" Width="850px" CaptionAlign="Top"
            ...
            <div style="width: 100%;" align="center" id="dvempty" runat="server" visible="false">
                <div>
                    <table cellspacing="2" cellpadding="3" rules="cols" style="background-color: White; border-color: #999999; border-width: 1px; border-style: None;  width: 850px;">
